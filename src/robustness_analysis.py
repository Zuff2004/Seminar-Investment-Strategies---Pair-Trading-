"""
Optional robustness analysis around the final ON/PN portfolio pipeline.

The baseline results are generated by ``final_main.py``.  This script reuses the
same construction logic and reruns the portfolio under alternative parameters
such as signal thresholds, rolling windows, transaction costs, and tax settings.
"""
